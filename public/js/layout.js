...
var Layout = (function () {
    ...
    var handleHorizontalMenu = function () {
        ...
        $(".page-header").on("click", ".search-form", function (e) {
            ...
            $(".page-header .search-form .form-control").on(
                "blur",
                function (e) {
        ...
        $(".full-height-content").each(function () {
            ...
            if (target.hasClass("portlet")) {
                ...
                App.destroySlimScroll(
                    portletBody.find(".full-height-content-body")
                ); // destroy slimscroll
                ...
                height =
                    ...
                    parseInt(
                        target.find(".portlet-body").css("padding-top"),
                        10
                    ) -
                    parseInt(
                ...
                if (
                    ...
                    target
                        ...
                        .css("height", height);
                    App.initSlimScroll(
                        target.find(".full-height-content-body")
                    );
                } else {
        ...
        loadAjaxContent: function (url, sidebarMenuLink) {
            ...
            $.ajax({
                ...
                success: function (res) {
                    ...
                    for (
                        var i = 0;
                        i < ajaxContentSuccessCallbacks.length;
                        i++
                    ) {
