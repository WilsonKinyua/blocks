                                                    ...
                                                    <div class="swal2-content">
                                                        <div id="swal2-content" class="swal2-html-container"
                                                            ...
                                                            <form class="row business_form"
                                                                action="{{ route('admin.business.updateLogo', [$business->id]) }}"
                                ...
                                <div class="card card-topline-gray">
                                    <div class="card-head ">
                                        ...
                                        <ul class="mdl-menu mdl-menu--bottom-right mdl-js-menu mdl-js-ripple-effect"
                                            ...
                                            <li class="mdl-menu__item update_bs_profile" data-bs-toggle="modal"
                                                data-bs-target="#updateBusinessProfile"><i class="material-icons">sort</i>
                                                Update Profile
                                            </li>
                                        </ul>
                                    </div>
                                    {{-- update business details start --}}
                                    <div class="modal fade" id="updateBusinessProfile" tabindex="-1"
                                        aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                <div class="modal-body">
                                                    <div aria-labelledby="swal2-title" aria-describedby="swal2-content"
                                                        ...
                                                        <div class="swal2-content">
                                                            <div id="swal2-content" class="swal2-html-container"
                                                                style="display: block;">
                                                                <div class="card-head"><small class="text-uppercase">
                                                                        <i class="fa fa-image"></i> &nbsp; &nbsp;Update
